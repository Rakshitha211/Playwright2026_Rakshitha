//As an SDET, you receive an API response status code 
// and need to classify it. 
// Write a JavaScript program using a switch statement 
// that takes an HTTP status 
// code stored in a variable and 
// prints the category and a QA-friendly message.
let statuscode = 401;
...
switch(statuscode) {
    case 200:
        ...
        break;
    case 201:
        console.log("PASS - Created: Resource created successfull");
        break;
    case 301:
        console.log("WARNING - Moved Permanently: URL has change");
        break;
    case 400:
